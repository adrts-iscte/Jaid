...
class OtherClass {
    ...
    EnumToBeModified fieldInitializerchanged = EnumToBeModified.ENUM_CONSTANT_TO_BE_REMOVED;

    EnumToBeModified newEnumField = EnumToBeModified.ENUM_CONSTANT_TO_BE_REMOVED;
}
