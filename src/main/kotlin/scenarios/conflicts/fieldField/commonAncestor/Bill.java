...
package scenarios.conflicts.fieldField.commonAncestor;
...
public class Bill {
    ...
    int fieldToHaveInitializerAndTypeChanged;

    //bba81dab-192b-46ee-9330-97e70face38a
    int fieldToHaveInitializerNullAndTypeChanged = 0;
